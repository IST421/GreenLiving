...
<asp:ImageButton ID="SpanishFlag" ImageUrl="~/Images/f3.png" AlternateText="espanol" runat="server" Height="25" Width="30" OnClick="SpanishFlag_Click" />

<asp:ImageButton ID="GermanFlag" ImageUrl="~/Images/f2.png" AlternateText="deutsch" runat="server" Height="25" Width="30" OnClick="GermanFlag_Click" />